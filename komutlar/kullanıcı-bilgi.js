...
exports.run = async (client, message, args) => {
  ...
  const Durum = user.presence.status;
            ...
            const durm = (Durum == "online" ? (client.emojis.get('692483724100501535') + "Çevrimiçi") : (Durum == "offline" ? (client.emojis.get('682602122810097676') + "Çevrimdışı") : (Durum == "idle" ? (client.emojis.get('682602153575186710') + "Boşta") : (Durum == "dnd" ? (client.emojis.get('682602188840763542') + "Rahatsız Etmeyin") : ("Bilinmiyor/bulunamadı.")))))
